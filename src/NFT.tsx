...
const selectedToItemIds = (currentImages, isShowingPixel) => {
  if (isShowingPixel) {
    return {
      ...
      ARMOR: [
        ...
        271, 272, 275, 305, 311, 313, 315, 330, 336, 342, 343, 351, 354,
      ],
      FACE_ARMOR: [
      ...
      EYEWEAR: [
        ...
        181, 199, 218, 241, 247, 256, 264, 323, 326, 327, 328, 329, 332,
      ],
      WEAPON: [
  ...
  return {
    BACKGROUND: [
      ...
      252, 255, 265, 266, 267, 268, 276, 277, 286, 304, 309, 318,
    ],
    HEAD: [
      0, 9, 32, 41, 42, 49, 53, 55, 58, 62, 64, 73, 82, 83, 98, 99, 104, 108,
