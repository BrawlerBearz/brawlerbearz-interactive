...
const selectedToItemIds = (currentImages, isShowingPixel) => {
  if(isShowingPixel){
    return {
      ...
      HEAD: [
        ...
        158, 164, 165, 191, 193, 194, 196, 198, 205, 206, 208, 215, 216, 236, 237, 244,
        253, 258, 260, 261
      ],
      ARMOR: [
        0, 1, 4, 34, 35, 37, 38, 43, 44, 48, 52, 54, 57, 61, 63, 71, 75, 76, 84,
        87, 95, 96, 97, 105, 106, 107, 109, 110, 111, 112, 114, 116, 117, 122, 123,
      ...
      FACE_ARMOR: [0, 15, 91, 171, 172, 187, 188, 195, 230, 235, 238],
      EYEWEAR: [
  ...
  return {
    ...
    HEAD: [
      0, 9, 32, 41, 42, 49, 53, 55, 58, 62, 64, 73, 82, 83, 98, 99, 104, 108,
      113, 115, 119, 121, 124, 131, 132, 133, 134, 135, 140, 143, 145, 149, 157,
      158, 164, 165, 191, 206, 208, 215, 216, 236, 237, 244,
      253, 258,
    ],
    ARMOR: [
      0, 1, 4, 34, 35, 37, 38, 43, 44, 48, 52, 54, 57, 61, 63, 71, 75, 76, 84,
    ...
    MISC: [
      ...
      182, 183, 189, 201, 202, 203, 207,  220, 225,
    ],
    WEAPON: [
      0, 2, 3, 6, 16, 17, 18,  25, 26, 27, 28, 29, 30, 31, 33, 36, 45, 46,
      50, 56, 65, 86, 90, 94, 139, 159, 163, 173, 174, 175, 176, 177, 189, 192, 204,
