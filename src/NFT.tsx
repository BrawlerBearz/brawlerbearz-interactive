...
const selectedToItemIds = (currentImages, isShowingPixel) => {
  if (isShowingPixel) {
    return {
      BACKGROUND: [
        ...
        242, 252, 255, 265, 266, 267, 268, 276, 277, 286, 304, 309, 318,
      ],
      HEAD: [
        ...
        244, 253, 258, 260, 261, 278, 280, 283, 284, 314, 321, 322,
      ],
      ARMOR: [
      ...
      MISC: [
        ...
        285, 303, 306, 308, 310, 312, 319, 320,
      ],
      WEAPON: [
  ...
  return {
    ...
    ARMOR: [
      ...
      239, 243, 245, 248, 249, 250, 251, 257, 259, 271, 272, 275,
    ],
    ...
    WEAPON: [
      ...
      213, 217, 222, 223, 227, 231, 234, 246, 254, 282, 288, 289,
    ],
  };
};
